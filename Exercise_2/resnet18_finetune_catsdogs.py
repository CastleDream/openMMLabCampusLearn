...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/content/cats_dogs_dataset/training_set',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/content/cats_dogs_dataset/val_set',
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/content/cats_dogs_dataset/test_set',
        # ann_file='meta/val.txt',
        # data_prefix='val',
        pipeline=test_pipeline),
    sampler=dict(type='DefaultSampler', shuffle=False),
