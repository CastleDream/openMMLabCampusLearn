...
data_mode = 'topdown'
data_root = '/content/Ear210_Keypoint_Dataset_coco/'
...
# sigma 表示关键点一维高斯分布的标准差，越大越容易学习，但精度上限会降低，越小越严格，对于人体、人脸等高精度场景，可以调小，RTMPose
# 原始论文中为 5.66

# 不同模型的 config：
# https://github.com/open-mmlab/mmpose/tree/dev-1.x/projects/rtmpose/rtmpose/body_2d_keypoint
